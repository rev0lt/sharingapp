...
public class ShootActivity extends Activity {
	...
	public void onCreate(Bundle bundle) {
		...
		userDataDialog.setContentView(R.layout.dialog_userdata);
	...
	public void showDialog(UserData user) {
		...
		((TextView) userDataDialog
				.findViewById(R.id.userdata_facebook)).setText(user.getFacebook());
		((TextView) userDataDialog
				.findViewById(R.id.userdata_linkedin)).setText(user.getLinkedIn());
		((TextView) userDataDialog
				.findViewById(R.id.userdata_name)).setText(user.getName());
		((TextView) userDataDialog
				.findViewById(R.id.userdata_twitter)).setText(user.getTwitter());
		userDataDialog.show();
    }
}
